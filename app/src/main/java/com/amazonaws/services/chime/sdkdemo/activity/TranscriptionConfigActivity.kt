...
//            },
//            contentRedactionType = transcribeContentRedaction?.let {
// TRANSCRIBE_CONTENT_IDENTIFICATION_TYPE },
...
//                if (it == TRANSCRIBE_PARTIAL_RESULTS_STABILIZATION_DEFAULT)
// TRANSCRIBE_PARTIAL_RESULTS_STABILIZATION_HIGH
//                else it
//            },
//            piiEntityTypes = transcribeContentIdentification?.let { identification ->
//                if (identification.isEmpty() || isTranscribeMedical) null
//                else identification
//            } ?: run { if (transcribeContentRedaction.isNullOrEmpty()) null else
// transcribeContentRedaction },
...
//        } else ""
//        val meetingUrl = if (meetingEndpointUrl.endsWith("/")) meetingEndpointUrl else
...
//            response.data
//        } else {
//            logger.error(TAG, "Error sending start transcription request
